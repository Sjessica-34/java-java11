...
//<------------------------------> Autre syntaxe // corrigé
       // Map<Gender, String> result =customers.stream().sorted(Comparator.comparing(c->c.getFirstname())).collect(Collectors.toMap(c->c.getGender(),c->c.getFirstname(),(a,b)-> a+"|"+b));
